...
const indicatorsCount = async () => {
  ...
  let l = ``;
  for (let i = 0; i < imgs.length - 1; i++) {
    l += `<li data-target="#myCarousel" data-slide-to='${i}' class="${
      i == 0 ? "active" : ""
    }"></li>`;
  }
  return l;
...
const checkTabs = async () => {
  for (let i = 0; i < mounts.length; i++) {
    if (
      ...
      highrange.innerHTML = `<div class="sectionc-banner" style="background: url('/assets/images/mountain-1.png') no-repeat">
      ...
      highrange.innerHTML = `<div class="sectionc-banner" style="background: url('/assets/images/mountain-2.png') no-repeat">
...
<div class="attribution">
    <p class="footer-text">COPYRIGHT ${new Date().getFullYear()} ALL RIGHTS RESERVED <br/> CREATED WITH ❤️ BY SYED FARAJUDDIN</p>
</div>
</div>`;
